<template>
  <div class="px-4 py-2" style="background-color: #eeeeee; margin-bottom: 80px">
    <div>
      <div v-for="(item, index) in posts" :key="item.id" class="card postcard">
        ...
        >
          ...
          <span class="badge badge-light-primary px-4 py-2 fs-5">{{
            item.category
          }}</span>
    ...
    <div class="mb-10">
      <button
        class="btn btn-light-primary w-100 mt-3 fs-1"
        @click="goToPostWrite()"
      >
